                    ...
                    return (
                        ...
                        this.each(function () {
                            ...
                            ;(a || ((a = new e(n.default(this), i)), n.default(this).data(He, a)),
                                'init' === t || '' === t
                                    ? a._init()
                                    : ('fixLayoutHeight' !== t && 'fixLoginRegisterHeight' !== t) ||
                                      a[t]())
                        })
                    )
                }),
                ...
                (t.autoCollapse = function (e) {
                    if ((void 0 === e && (e = !1), this._options.autoCollapseSize)) {
                        ...
                        n.default(window).width() <= this._options.autoCollapseSize
                            ...
                            : !0 === e &&
                              (t.hasClass(Je) ? t.removeClass(Je) : t.hasClass(Ve) && this.expand())
                    }
                }),
                (t.remember = function () {
                ...
                (t.create = function () {
                    ...
                    if (
                        ...
                        null != this._config.title &&
                            t.append(
                                n.default('<strong />').addClass('mr-auto').html(this._config.title)
                            ),
