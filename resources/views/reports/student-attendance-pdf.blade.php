...
<head>
    ...
    <style>
        ...
        .header h2 { margin: 5px 0; color: #001f3f; }
        .filter-info { margin-bottom: 15px; padding: 10px; background-color: #f5f5f5; border-left: 4px solid #001f3f; }
        .filter-info p { margin: 3px 0; }
        table { width: 100%; border-collapse: collapse; margin-bottom: 20px; }
        table th { background-color: #001f3f; color: white; padding: 8px; text-align: left; font-size: 9px; }
        table td { padding: 6px 8px; border: 1px solid #ddd; font-size: 9px; }
        table tr:nth-child(even) { background-color: #f9f9f9; }
        .summary { margin-top: 20px; padding: 15px; background-color: #f0f8ff; border: 1px solid #001f3f; }
        .summary h3 { margin-top: 0; color: #001f3f; }
        .summary-grid { display: grid; grid-template-columns: repeat(3, 1fr); gap: 10px; }
        .summary-item { padding: 8px; background-color: white; border-left: 3px solid #001f3f; }
        .summary-item strong { display: block; color: #666; font-size: 9px; }
        .summary-item span { display: block; font-size: 16px; font-weight: bold; color: #001f3f; }
                    ...
                    <tr>
                        ...
                        <td style="text-align: center;">
                            @php
                                ...
                                $status = $statusMap[$detail->status] ?? ['label' => $detail->status, 'class' => ''];
                            @endphp
    ...
    <div class="summary">
        ...
        <div class="summary-grid">
            ...
            <div class="summary-item">
                ...
                <span>{{ $summary['absent_count'] }}</span>
            </div>
            <div class="summary-item">
                <strong>Sakit</strong>
